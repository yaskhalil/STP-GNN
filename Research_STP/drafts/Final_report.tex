...
\begin{document}
	...
	\section{Next Steps}
	The core mathematical architecture is now verified, and the biological predictions demonstrate empirical parity with clinical data. Over the next 1-2 weeks, my immediate priority is to begin consolidating these findings and prewriting the comprehensive end-of-semester research report.
